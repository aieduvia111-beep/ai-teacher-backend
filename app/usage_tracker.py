...
def _record(label: str, resp, model_hint: str, is_stream: bool):
    try:
...
def install():
    ...
    try:
        ...
        def sync_wrapper(self, *args, **kwargs):
            ...
            try:
                _record(label, resp, kwargs.get("model"), bool(kwargs.get("stream")))
            except Exception:
                pass
            return resp
        ...
        def async_wrapper(self, *args, **kwargs):
            ...
            async def _run():
                resp = await coro
                try:
                    _record(label, resp, model_hint, is_stream)
                except Exception:
                    pass
                return resp
            return _run()
