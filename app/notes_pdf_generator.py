...
SIZE_CONFIG = {
    2: dict(n_pojecia='3-4', n_sekcje=3, n_bledy=2, n_quiz=3, n_zapamietaj=4),   # Szybka ~4 str
    3: dict(n_pojecia='5-6', n_sekcje=5, n_bledy=3, n_quiz=5, n_zapamietaj=6),   # Normalna ~8 str
    4: dict(n_pojecia='6-7', n_sekcje=7, n_bledy=4, n_quiz=6, n_zapamietaj=7),   # Dokladna ~11 str
    5: dict(n_pojecia='7-8', n_sekcje=9, n_bledy=5, n_quiz=8, n_zapamietaj=8),   # Mega ~15 str
}
