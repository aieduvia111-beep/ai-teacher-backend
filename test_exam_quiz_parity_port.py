...
print("   45s dla trudny/trudna (OBNIZONE 30.08.2026, 'max 1 minuta zamiast 4")
print("   minut' - po archetypach Safe Parameter Generation dlugi budzet nie")
print("   jest juz potrzebny, patrz komentarz nad _HARD_TIMEOUT_SECONDS_EXAM)")
print("=" * 70)

check("rownania kwadratowe + srednia -> 60s", _max_generation_seconds_exam("Rownania kwadratowe", "srednia") == 60.0, None)
check("rownania kwadratowe + trudna -> 45s (obnizone 30.08.2026, 'max 1 minuta')", _max_generation_seconds_exam("Rownania kwadratowe", "trudna") == 45.0, None)
